  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        />
        <Route
          path="/tenants/:tenantId/divisions/:divisionId/teams/new"
          element={<TeamCreate email={session?.user?.email} />}
        />
        <Route
          path="/tenants/:tenantId/divisions/:divisionId/teams/:teamId"
          element={<TeamDetail email={session?.user?.email} />}
        />
        <Route
          path="/tenants/:tenantId/divisions/:divisionId/import"
          element={<RosterImport email={session?.user?.email} />}
        />
      </Routes>
    </BrowserRouter>
  );
